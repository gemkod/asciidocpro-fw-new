...
[void]$outputLines.Add("//")
[void]$outputLines.Add(":adp_fw_version_number: $newVersion")
[void]$outputLines.Add(":adp_fw_version_date: $versionDate")
[void]$outputLines.Add(":adp_fw_version_note: $versionNote")
foreach ($source in $groups.Keys) {
    [void]$outputLines.Add("//")
